...
class DefenseBuilding : public AreaController {
public:
    DefenseBuilding();
    DefenseBuilding(int32_t cx, int32_t cy, Player *player, Camera *camera, SoundQueue *soundQueue, Storage *storage);

    [[nodiscard]] bool readyToShoot() const;
    void shoot();
protected:
